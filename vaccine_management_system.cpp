...
void vaccine ::view_vaccine()
{
    ...
    cout<<"\t\t\t\t\t\t Developed by : VIVEK KUMAR "<<endl<<endl;
    cout<<"\n\t\t\t*****************************************\n";
...
void vaccine::search_by_aadhar()
{
    ...
    if(flag==0)
    {
        cout<<"Aadhaar number not found "<<endl;
    }
    in.close();
}
...
void vaccine::showdata()
{
   ...
   cout<<"\t\t Aadhaar number is: "<<aadhar<<endl;
